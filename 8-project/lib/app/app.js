...
(function(){
    function App(options) {
        var opt = {
            ...
            pageFn: function(hash, temId,temUrl) {
                ...
                this.temUrl = temUrl||'';
                this.active = false;
                this.elem = $('<div class="view" hash="' + hash + '"></div>');
            },
            animate: {
    ...
    App.prototype = {
        init: function() {
            ...
            //      var currentState = history.state||event.state;
        ...
        setPage: function(hash,args) {
            var self=this, hashs=[],split=self.hashSplit;
            args=args||'';
            //还在切换页面
            if (this.isLoading) {
                return false;
    ...
    if (typeof define === 'function' && typeof define.amd === 'object' && define.amd) {
        ...
        module.exports.webApp = function(opt){
            return new App(opt);
        };
    } else {
